        ...
        <div class="modal-header">
          <div class="app-info">
            ...
            <div class="app-details">
              ...
              <p class="app-author">
                {{ t("apps.details.author") }}: {{ app.author }}
              </p>
              <div class="app-rating" v-if="app.rating > 0">
                ...
                <span class="rating-text">
                  {{ app.rating.toFixed(1) }} ({{ app.reviews_count }}
                  {{ t("apps.reviews.title").toLowerCase() }})
                </span>
              </div>
            </div>
          </div>
        ...
        <div class="modal-body">
          <div class="content-grid">
            ...
            <div class="main-content">
              ...
              <div class="section">
                <h3 class="section-title">
                  {{ t("apps.details.description") }}
                </h3>
                <div
                  class="description"
                  v-html="app.description_html || app.description"
                ></div>
              </div>
              ...
              <div class="section">
                ...
                <div
                  v-if="app.reviews && app.reviews.length > 0"
                  class="reviews-list"
                >
                  <div
              ...
              <div class="action-section">
                <template v-if="isInstalled">
                  ...
                  <div class="installed-actions">
                    ...
                    <button v-else @click="handleActivate" class="btn-activate">
                      {{ t("apps.actions.activate") }}
                    </button>
                    <button @click="handleUninstall" class="btn-uninstall">
                ...
                <template v-else>
                  ...
                  <div class="pricing-card">
                    ...
                    <div v-else class="price-paid">
                      ...
                      <span
                        v-if="app.billing_type === 'monthly'"
                        class="billing-type"
                      >
                        /{{ t("apps.pricing.month") }}
                      </span>
                      <span
                        v-else-if="app.billing_type === 'yearly'"
                        class="billing-type"
                      >
                        /{{ t("apps.pricing.year") }}
                      </span>
                  ...
                  >
                    <span v-if="installing"
                      >{{ t("apps.actions.installing") }}...</span
                    >
              ...
              <div class="info-section">
                <div class="info-item">
                  <span class="info-label">{{
                    t("apps.details.version")
                  }}</span>
                  <span class="info-value">{{ app.version }}</span>
                </div>
                <div class="info-item">
                  <span class="info-label">{{
                    t("apps.details.install_count")
                  }}</span>
...
const hasLinks = computed(() => {
  return (
    props.app.website_url ||
    props.app.documentation_url ||
    props.app.support_url
  );
});
