        ...
        <div class="modal-body">
          ...
          <div class="metrics-grid">
            <div class="metric-card">
              ...
              <div class="metric-info">
                <div class="metric-value">
                  {{ formatNumber(analytics.total_usage || 0) }}
                </div>
                <div class="metric-label">
                  {{ t("apps.analytics.total_usage") }}
                </div>
            ...
            <div class="metric-card">
              ...
              <div class="metric-info">
                <div class="metric-value">
                  {{ formatNumber(analytics.api_calls || 0) }}
                </div>
                <div class="metric-label">
                  {{ t("apps.analytics.api_calls") }}
                </div>
              ...
              <div class="chart-header">
                ...
                <div class="chart-controls">
                  <select v-model="usageChartType" class="chart-select">
                    <option value="line">
                      {{ t("apps.analytics.line_chart") }}
                    </option>
                    <option value="bar">
                      {{ t("apps.analytics.bar_chart") }}
                    </option>
                  </select>
                </div>
              </div>
            ...
            <div class="stats-grid">
              <div class="stat-section">
                <h4 class="section-title">
                  {{ t("apps.analytics.usage_breakdown") }}
                </h4>
                <div class="stat-items">
                  <div class="stat-item">
                    <span class="stat-label">{{
                      t("apps.analytics.daily_avg")
                    }}</span>
                    <span class="stat-value">{{
                      formatNumber(analytics.daily_average || 0)
                    }}</span>
                  </div>
                  <div class="stat-item">
                    <span class="stat-label">{{
                      t("apps.analytics.peak_usage")
                    }}</span>
                    <span class="stat-value">{{
                      formatNumber(analytics.peak_usage || 0)
                    }}</span>
                  </div>
                  <div class="stat-item">
                    <span class="stat-label">{{
                      t("apps.analytics.off_peak_usage")
                    }}</span>
                    <span class="stat-value">{{
                      formatNumber(analytics.off_peak_usage || 0)
                    }}</span>
                  </div>
                </div>
              </div>
              ...
              <div class="stat-section">
                <h4 class="section-title">
                  {{ t("apps.analytics.error_analysis") }}
                </h4>
                <div class="stat-items">
                  <div class="stat-item">
                    <span class="stat-label">{{
                      t("apps.analytics.total_errors")
                    }}</span>
                  ...
                  <div class="stat-item">
                    <span class="stat-label">{{
                      t("apps.analytics.error_rate")
                    }}</span>
                    <span class="stat-value error"
                      >{{ (analytics.error_rate || 0).toFixed(2) }}%</span
                    >
                  </div>
                  <div class="stat-item">
                    <span class="stat-label">{{
                      t("apps.analytics.last_error")
                    }}</span>
                    <span class="stat-value">
                      {{
                        analytics.last_error_at
                          ? formatDate(analytics.last_error_at)
                          : t("apps.analytics.no_errors")
                      }}
                    </span>
                  </div>
                </div>
              ...
              <div class="stat-section">
                <h4 class="section-title">
                  {{ t("apps.analytics.response_times") }}
                </h4>
                <div class="stat-items">
                  <div class="stat-item">
                    <span class="stat-label">{{
                      t("apps.analytics.avg_response_time")
                    }}</span>
                    <span class="stat-value"
                      >{{
                        (analytics.avg_response_time || 0).toFixed(0)
                      }}ms</span
                    >
                  </div>
                  <div class="stat-item">
                    <span class="stat-label">{{
                      t("apps.analytics.fastest_response")
                    }}</span>
                    <span class="stat-value success"
                      >{{
                        (analytics.min_response_time || 0).toFixed(0)
                      }}ms</span
                    >
                  </div>
                  <div class="stat-item">
                    <span class="stat-label">{{
                      t("apps.analytics.slowest_response")
                    }}</span>
                    <span class="stat-value warning"
                      >{{
                        (analytics.max_response_time || 0).toFixed(0)
                      }}ms</span
                    >
                  </div>
                </div>
          ...
          <div v-if="recentActivity.length > 0" class="activity-section">
            <h4 class="section-title">
              {{ t("apps.analytics.recent_activity") }}
            </h4>
