            ...
            <div class="relative bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-2xl font-bold text-gray-900">Webhook Configuration</h2>
                    ...
                    <form @submit.prevent="saveWebhook" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <div v-for="event in availableEvents" :key="event.value" class="flex items-center">
                                    ...
                                    />
                                    <label :for="`event-${event.value}`" class="ml-2 block text-sm text-gray-900">
                                        {{ event.label }}
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center">
                            <input 
                                ...
                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                            />
                            <label for="webhook-active" class="ml-2 block text-sm text-gray-900">
                                Enable webhook
                            </label>
                        </div>
