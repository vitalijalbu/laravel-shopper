      ...
      <div class="app-info">
        ...
        <div class="app-meta">
          <span class="app-author"
            >{{ t("apps.details.author") }}: {{ app.author }}</span
          >
          <span class="app-installs"
            >{{ formatNumber(app.installs) }}
            {{ t("apps.details.install_count").toLowerCase() }}</span
          >
        </div>
    ...
    <div class="app-actions">
      <template v-if="isInstalled">
        ...
        <div class="action-buttons">
          ...
          <button v-else @click="$emit('activate', app)" class="btn-activate">
            {{ t("apps.actions.activate") }}
          </button>
          <button @click="$emit('uninstall', app)" class="btn-uninstall">
      ...
      <template v-else>
        ...
        <button @click="$emit('view-details', app)" class="btn-details">
