<template>
  <div class="entry-card bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-200 group">
    <div class="p-6">
      <!-- Header -->
      <div class="flex items-start justify-between mb-4">
        <div class="flex-1">
          <div class="flex items-center space-x-2 mb-2">
            ...
            <span v-if="entry.is_featured" class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-yellow-100 text-yellow-800">
              ⭐ Featured
            </span>
          </div>
        ...
        <div class="flex items-center space-x-2">
          ...
          <!-- Site Badge -->
          <span v-if="entry.site && entry.site !== 'default'" class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800">
            {{ entry.site }}
          </span>
        </div>
      </div>
      ...
      <!-- Preview Text -->
      <p class="text-gray-600 text-sm mb-4 line-clamp-2" v-if="entry.excerpt || entry.description">
      ...
      <div class="flex items-center justify-between text-sm text-gray-500 mb-4">
        ...
        <div class="flex items-center space-x-2">
          ...
          <span v-if="entry.stock_quantity !== undefined" class="flex items-center space-x-1" :class="{
            'text-red-600': entry.stock_quantity === 0,
            'text-yellow-600': entry.stock_quantity > 0 && entry.stock_quantity <= 10,
