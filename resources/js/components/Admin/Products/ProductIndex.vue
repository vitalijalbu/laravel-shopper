  ...
  <div class="product-index">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex space-x-3">
        <button @click="importProducts" class="btn btn-secondary">
        ...
        <router-link to="/cp/products/create" class="btn btn-primary">
          {{ t("products.create") }}
        </router-link>
      </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm">
      ...
      >
        <span class="text-sm text-gray-700">
          {{
            tc("admin.pagination.selected_items", selectedProducts.length, {
        ...
        <div class="flex space-x-2">
          ...
          <button @click="bulkAction('delete')" class="btn btn-sm btn-danger">
      ...
      <div class="px-4 py-3 border-t border-gray-200">
        <div class="flex items-center justify-between">
          ...
          <pagination :data="products" @page-change="loadProducts" />
        </div>
      </div>
    </div>
...
export default {
  ...
  setup(props) {
    ...
    const allSelected = computed(() => {
      return (
        selectedProducts.value.length === products.value.data.length &&
