    ...
    <div class="space-y-6">
      ...
      >
        ...
        <div class="mt-1">
          ...
          <input
            v-if="['text', 'email', 'password', 'url', 'number'].includes(field.type)"
            :id="field.name"
            :name="field.name"
            :type="field.type"
...
const getInputClass = (field) => {
  const baseClass = 'block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm'
  const errorClass = props.errors[field.name] ? 'border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500' : ''
