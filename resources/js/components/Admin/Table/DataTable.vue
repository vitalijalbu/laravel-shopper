      ...
      <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <tr
            ...
            :class="[
              'hover:bg-gray-50',
              selectedItems.includes(getRowKey(item, index)) ? 'bg-gray-50' : ''
            ]"
          >
            <!-- Checkbox column -->
            ...
            <!-- Actions column -->
            <td v-if="rowActions.length" class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
...
// Emits
const emit = defineEmits(['selection-change', 'sort-change', 'filter-change', 'search'])
...
const getActionClass = (action) => {
  const baseClass = 'inline-flex items-center px-3 py-2 border text-xs font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2'
