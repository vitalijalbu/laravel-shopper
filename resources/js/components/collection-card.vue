<template>
  <div
    class="collection-card bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-200"
  >
    <div class="p-6">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4 text-sm text-gray-500">
          <span v-if="collection.entries_count !== undefined">
            ...
            {{ collection.entries_count === 1 ? "entry" : "entries" }}
          </span>
