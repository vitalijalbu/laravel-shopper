...
export const useLocaleStore = defineStore('locale', () => {
  ...
  const availableLocales = ref(window.ShopperConfig?.availableLocales || { en: 'English', it: 'Italiano' })
  const translations = ref(window.ShopperConfig?.translations || {})
  const translator = ref(new Translator(translations.value, currentLocale.value))
