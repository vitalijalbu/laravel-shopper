...
const props = withDefaults(defineProps<Props>(), {
  period: '30',
  widgets: () => ['revenue_chart', 'orders_chart', 'visitors_chart', 'top_products', 'recent_orders'],
})
...
const revenueChartData = computed(() => ({
  labels: props.revenue_data.chart_data.map(d => new Date(d.date).toLocaleDateString()),
  datasets: [
    {
      label: 'Revenue',
...
const ordersChartData = computed(() => ({
  labels: props.orders_data.chart_data.map(d => new Date(d.date).toLocaleDateString()),
  datasets: [
    {
      label: 'Orders',
...
const visitorsChartData = computed(() => ({
  labels: props.visitors_data.chart_data.map(d => new Date(d.date).toLocaleDateString()),
  datasets: [
    {
      label: 'Visitors',
    ...
    <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-gray-600 mt-1">Monitor your store's performance and insights</p>
        </div>
            ...
            <div class="space-y-4">
              ...
              >
                <div>
                  ...
                  <p class="text-sm text-gray-600">{{ formatNumber(product.views) }} views</p>
                </div>
                <div class="text-right">
                  <p class="font-medium text-gray-900">{{ product.sales }} sales</p>
                </div>
              </div>
            </div>
          </CardContent>
