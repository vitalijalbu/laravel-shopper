...
const getEventTypeBadgeClass = (eventType: string) => {
  ...
  return (
    classes[eventType as keyof typeof classes] || "bg-gray-100 text-gray-800"
  );
};
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-gray-600 mt-1">
            View detailed analytics events and user interactions
          </p>
        </div>
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                >
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <div v-else class="text-sm text-gray-500">Guest</div>
                  </td>
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center gap-2">
                <button
                  ...
                  @click="
                    router.get(
                      `/admin/analytics/events?page=${events.current_page - 1}`,
                    )
                  "
                  class="btn btn-outline btn-sm"
                  :class="{
                    'opacity-50 cursor-not-allowed': events.current_page === 1,
                  }"
                >
                  Previous
                </button>
